    ...
    <div style={{ display: 'flex', minHeight: '100vh', background: 'var(--bg)' }}>
      <aside style={{
        ...
        <div style={{ padding: '20px 20px 16px', borderBottom: '1px solid var(--border)' }}>
          <div style={{ fontFamily: 'var(--mono)', fontSize: '20px', fontWeight: '700', color: 'var(--accent)' }}>crackd.</div>
            ...
            <div key={group} style={{ marginBottom: '4px' }}>
              ...
              {items.map(({ href, label, icon }) => (
                <Link key={href} href={href} className="nav-link" style={{
                  ...
                  fontFamily: 'var(--mono)', marginBottom: '1px',
                }}>
                  <span style={{ fontSize: '10px', width: '14px', textAlign: 'center' }}>{icon}</span>
                  {label}
                </Link>
              ))}
            </div>
        ...
        <div style={{ padding: '12px 16px', borderTop: '1px solid var(--border)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '10px' }}>
            ...
            <div>
              <div style={{ fontSize: '12px', fontWeight: '500', fontFamily: 'var(--mono)' }}>{displayName}</div>
